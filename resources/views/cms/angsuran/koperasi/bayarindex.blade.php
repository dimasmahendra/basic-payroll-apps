@php
    ...
    $breadcrumbs[] = ["label" => "Angsuran Koperasi", "url" => "#"];
...
<div class="card">
    ...
    <div class="card-body">
        <form id="form-bayar-angsuran-koperasi" method="POST" action="{{ route('angsuran.bayar') }}">
            {{ csrf_field() }}
            <div class="col-md-2">
            ...
            <input type="hidden" name="jenis_angsuran" value="koperasi" />
    ...
    <script>
        function init() {
            ...
            $(document).on('click', '#simpan-bayar-angsuran', function() {
                $("#form-bayar-angsuran-koperasi").submit();
            });
